...
#         self.play_icon = self.play_icon.resize((70, 70), Image.ANTIALIAS)
#         self.play_icon = ImageTk.PhotoImage(self.play_icon)

#         self.pause_icon = Image.open('images/pause.png')
#         self.pause_icon = self.pause_icon.resize((70, 70), Image.ANTIALIAS)
...
#         self.stop_icon = self.stop_icon.resize((70, 70), Image.ANTIALIAS)
...
#     def add_songs(self):
#         songs = fd.askopenfilenames(title="Select Music Folder", filetypes=(('mp3 files', '*.mp3'),))
#         for song in songs:
